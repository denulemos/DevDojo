...
- Delegation: Decidir qué trabajo prefieres hacer tú o dejarle a la IA.
- Description: Comunicación clara con los sistemas de IA.
- Discernimiento: Evaluar la respuesta de la IA con un ojo crítico.
- Diligence: Asegurarse de que nuestras interacciones con la IA sean responsables.

Por ejemplo, se tiene un proyecto relacionado con la comunicación donde debemos enviar emails de marketing.

- Delegation: ¿Cuáles aspectos del proyecto vas a dejar a la IA? Por ejemplo, la redacción de los emails.
- Description: ¿Qué instrucciones le vas a dar a la IA para que redacte los emails? Por ejemplo, "Redacta un email de marketing para promocionar nuestro nuevo producto, asegúrate de incluir un llamado a la acción claro y un tono amigable".
- Discernimiento: Evaluar la respuesta de la IA con un ojo crítico. Por ejemplo, revisar el email redactado por la IA para asegurarse de que cumple con los requisitos y tiene un tono adecuado.
- Diligence: Asegurarse de que nuestras interacciones con la IA sean responsables. Por ejemplo, asegurarse de que el email redactado por la IA no contenga información falsa o engañosa.
